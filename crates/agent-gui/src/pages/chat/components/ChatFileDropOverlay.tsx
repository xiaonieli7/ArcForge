...
/** Full-chat drop-zone overlay shown while a Tauri drag-drop is in flight. */
export function ChatFileDropOverlay(props: ChatFileDropOverlayProps) {
