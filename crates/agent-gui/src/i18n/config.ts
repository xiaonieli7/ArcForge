...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.workspaceRemoveDescription": "会删除此项目下的历史对话，不会删除文件夹。",
    "chat.workspaceOpenSystemFileManagerFailed": "打开资源管理器失败",
    "scheduled.title": "已安排",
    "scheduled.subtitle": "管理定时任务与工作流触发器",
    "scheduled.cronTab": "定时任务",
    "scheduled.hooksTab": "Hooks",
    "chat.exitConfirmTitle": "退出 ArcForge？",
    ...
    "chat.welcome": "欢迎使用 ArcForge",
    "chat.brandPositioning": "面向 Windows 专业用户的本地优先桌面 Work Agent",
    "chat.brandPromise":
      "将用户目标和本地上下文转化为可审查的交付物、可验证的证据，以及需要明确授权的真实动作。",
    "chat.greetingMorning": "早上好",
    "chat.greetingNoon": "中午好",
    "chat.greetingAfternoon": "下午好",
    "chat.greetingEvening": "晚上好",
    "chat.greetingNight": "夜深了",
    "chat.greetingSeparator": "，",
    ...
    "chat.generatedFiles.title": "生成的文件（{count}）",
    "chat.generatedFiles.titleOne": "生成的文件",
    "chat.generatedFiles.hint": "点击文件可在右侧预览",
    "chat.generatedFiles.openPreview": "在右侧预览",
    "chat.generatedFiles.reveal": "在文件树中定位",
    "chat.generatedFiles.previewUnavailable": "此格式暂不支持预览",
    "chat.generatedFiles.kind.file": "文件",
    "chat.generatedFiles.kind.spreadsheet": "Excel 表格",
    "chat.generatedFiles.kind.pdf": "PDF 文档",
    "chat.generatedFiles.kind.document": "Office 文档",
    "chat.generatedFiles.kind.image": "图片",
    "chat.generatedFiles.kind.text": "文本文件",
    "chat.generatedFiles.kind.audio": "音频",
    "chat.generatedFiles.kind.video": "视频",
    "chat.generatedFiles.kind.html": "网页文件",
    ...
    "chat.composer.add": "添加",
    "chat.composer.referenceFiles": "引用文件",
    "chat.composer.referenceSkills": "使用 Skill",
    "chat.composer.webSearch": "联网搜索",
    ...
    /* ── Settings About ── */
    "settings.aboutTitle": "关于 ArcForge",
    ...
    "settings.shortcutSummonDesc": "从任意位置立即唤起并聚焦 ArcForge 主窗口",
    ...
    "settings.shortcutPinDesc": "切换主窗口置顶，让 ArcForge 浮在其他应用上方",
    ...
    "settings.systemToolsBuiltinDesc": "ArcForge 在 Agent 模式下自动注册的内置工具，此处仅供查阅。",
    ...
    "settings.modelCost": "单价（美元 / 百万 token）",
    "settings.modelCostHint": "留空使用内置目录定价；目录外模型不填则不显示费用。",
    "settings.modelCostInput": "输入",
    "settings.modelCostOutput": "输出",
    "settings.modelCostCacheRead": "缓存读取",
    "settings.modelCostCacheWrite": "缓存写入",
    ...
    "settings.remoteDesc": "通过云端 Gateway 远程控制本地 ArcForge",
  ...
  "en-US": {
    ...
    "chat.workspaceSection": "Projects",
    "chat.workspaceCreate": "New project",
    "chat.workspaceNewConversation": "New conversation",
    "chat.workspaceMore": "More",
    "chat.workspacePin": "Pin project",
    "chat.workspaceUnpin": "Unpin",
    "chat.workspaceRename": "Rename",
    "chat.workspaceRemove": "Remove project",
    ...
    "chat.workspaceRemoveRunning":
      "A background task is running, so this project cannot be removed yet.",
    "chat.workspaceRemoveDescription":
      "This deletes conversations under the project, but it does not delete the folder.",
    "chat.workspaceOpenSystemFileManagerFailed": "Failed to open the file manager",
    "scheduled.title": "Scheduled",
    "scheduled.subtitle": "Manage scheduled tasks and workflow triggers",
    "scheduled.cronTab": "Scheduled tasks",
    "scheduled.hooksTab": "Hooks",
    "chat.exitConfirmTitle": "Exit ArcForge?",
    ...
    "chat.welcome": "Welcome to ArcForge",
    "chat.brandPositioning": "A local-first desktop Work Agent for Windows professionals",
    "chat.brandPromise":
      "Turn user goals and local context into reviewable deliverables, verifiable evidence, and real actions that require explicit authorization.",
    ...
    "chat.inputHint": "Type a message",
    "chat.inputHintWithSkills": "Type a message",
    ...
    "chat.generatedFiles.title": "Generated files ({count})",
    "chat.generatedFiles.titleOne": "Generated file",
    "chat.generatedFiles.hint": "Click a file to preview it on the right",
    "chat.generatedFiles.openPreview": "Preview on the right",
    "chat.generatedFiles.reveal": "Reveal in file tree",
    "chat.generatedFiles.previewUnavailable": "Preview unavailable for this format",
    "chat.generatedFiles.kind.file": "File",
    "chat.generatedFiles.kind.spreadsheet": "Excel workbook",
    "chat.generatedFiles.kind.pdf": "PDF document",
    "chat.generatedFiles.kind.document": "Office document",
    "chat.generatedFiles.kind.image": "Image",
    "chat.generatedFiles.kind.text": "Text file",
    "chat.generatedFiles.kind.audio": "Audio",
    "chat.generatedFiles.kind.video": "Video",
    "chat.generatedFiles.kind.html": "Web file",
    ...
    "chat.composer.referenceFiles": "Reference files",
    "chat.composer.referenceSkills": "Use a Skill",
    "chat.composer.webSearch": "Web search",
    "chat.composer.thinking": "Thinking",
    ...
    /* ── Settings About ── */
    "settings.aboutTitle": "About ArcForge",
    "settings.aboutDescription":
    ...
    "settings.shortcutSummonDesc": "Instantly bring up and focus the ArcForge window from anywhere",
    ...
    "settings.shortcutPinDesc": "Toggle always-on-top so ArcForge floats above other apps",
    ...
    "settings.systemToolsBuiltinDesc":
      "Built-in tools that ArcForge registers automatically in Agent mode. Read-only list; click the eye icon for details.",
    "settings.systemToolsCustomDesc":
    ...
    "settings.modelCost": "Pricing (USD / 1M tokens)",
    "settings.modelCostHint":
      "Leave blank to use catalog pricing; uncatalogued models show no cost unless filled in.",
    "settings.modelCostInput": "Input",
    "settings.modelCostOutput": "Output",
    "settings.modelCostCacheRead": "Cache read",
    "settings.modelCostCacheWrite": "Cache write",
    ...
    "settings.remoteDesc": "Control your local ArcForge remotely via cloud Gateway",
