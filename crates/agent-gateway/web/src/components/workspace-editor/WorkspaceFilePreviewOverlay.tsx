    ...
    <div
      className={cn(
        ...
        isDock
          ...
          : "absolute inset-0 z-40 transform-gpu border-r border-border transition-[opacity,transform,box-shadow] duration-200 ease-out motion-reduce:transition-none",
        isVisible &&
          (isDock
