...
ifeq ($(strip $(DESKTOP_VERSION)),)
	...
	LIVEAGENT_APP_VERSION="$(DESKTOP_VERSION)" pnpm --dir $(AGENT_GUI_DIR) tauri build --config $(DESKTOP_WINDOWS_TAURI_CONFIG) --config $(DESKTOP_VERSION_CONFIG) --target $(DESKTOP_WINDOWS_TARGET)
endif
